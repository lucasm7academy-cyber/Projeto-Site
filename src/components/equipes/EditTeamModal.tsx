...
import { Paintbrush, X, Upload, Check, RefreshCw } from 'lucide-react';
import { useSound } from '../../hooks/useSound';
import { Team, COLOR_THEMES } from '../../types/team';
import { validarImagem, uploadLogoTime } from '../../lib/uploadLogo';
        ...
        <div className="relative z-10">
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="h-8 rounded-xl mt-1" style={{ background: `linear-gradient(135deg, ${theme.from}, ${theme.to})` }} />
            </div>

            <div className="flex gap-3 pt-1">
              <button onClick={onClose} className="flex-1 py-3 bg-white/5 border border-white/10 text-white/60 rounded-xl text-sm font-bold hover:bg-white/10 transition-all">
                Cancelar
              </button>
              <button onClick={handleSave} className="flex-1 py-3 rounded-xl text-sm font-black transition-all hover:scale-105" style={{ background: theme.from, color: 'white' }}>
                Salvar
              </button>
            </div>
          </div>
